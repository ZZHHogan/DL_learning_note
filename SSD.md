...
![图1 不同检测算法的性能对比](https://pic2.zhimg.com/v2-f143b28b7a7a1f912caa9a99c1511849_b.jpg)

本文讲解的是SSD算法，其英文全名是Single Shot MultiBox Detector，名字取得不错，Single shot指明了SSD算法属于one-stage方法，MultiBox指明了SSD是多框预测。在上一篇文章中我们已经讲了YOLO算法，从图1也可以看到，SSD算法在准确度和速度（除了SSD512）上都比YOLO要好很多。图2给出了不同算法的基本框架图，对于Faster R-CNN，其先通过CNN得到候选框，然后再进行分类与回归，而YOLO与SSD可以一步到位完成检测。
...
![图2 不同算法的基本框架图](https://pic3.zhimg.com/v2-4c1d4d1b857a88b347549e54e15f322e_b.jpg)

### 设计理念

SSD和YOLO一样都是采用一个CNN网络来进行检测，但是却采用了多尺度的特征图，其基本架构如图3所示。下面将SSD核心设计理念总结为以下三点：

![图3 SSD基本框架](https://pic1.zhimg.com/v2-bfaaa064fb1f0c1c7a11a4ce79962e84_b.jpg)
...
![图4 不同尺度的特征图](https://pic2.zhimg.com/v2-4e827b166ba5cbaa5ac8b428a32b885d_b.jpg)
...
![图5 SSD的先验框](https://pic1.zhimg.com/v2-f6563d6d5a6cf6caf037e6d5c60b7910_b.jpg)
...
![图5 SSD网络结构](https://pic1.zhimg.com/v2-a43295a3e146008b2131b160eec09cd4_b.jpg)
...
![图6 扩展卷积](https://pic4.zhimg.com/v2-e3201dedee06e7793affbed4504add17_b.jpg)
...
![图7 基于卷积得到检测结果](https://pic1.zhimg.com/v2-2d20292e51ef0ce4008ef8a1cf860030_b.jpg)
...
![图8 先验框匹配示意图](https://pic3.zhimg.com/v2-174bec5acd695bacbdaa051b730f998a_b.jpg)
...
![img](https://pic3.zhimg.com/v2-a56019049a04217560ac498b626ad916_b.jpg)

![img](https://pic4.zhimg.com/v2-5853bed6e8796de582647f1e557b623b_b.jpg)
...
![image-20210925225656120](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20210925225656120.png)

对于置信度误差，其采用softmax loss:

![img](https://pic4.zhimg.com/v2-d28ded21949483b0fbb64b3612b0d543_b.jpg)
...
![img](https://pic1.zhimg.com/v2-616b035d839ec419ad604409d4abf6b0_b.jpg)
...
![表3 不同的trick组合对SSD的性能影响](https://pic4.zhimg.com/v2-1f12aabd1577fb996cc471814f68b673_b.jpg)

同样的，采用多尺度的特征图用于检测也是至关重要的，这可以从表4中看出：

![表4 多尺度特征图对SSD的影响](https://pic1.zhimg.com/v2-a4134f06b5d924067e3d262bc5d290d0_b.jpg)
